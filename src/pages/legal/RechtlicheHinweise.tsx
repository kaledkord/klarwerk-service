...
export default function RechtlicheHinweise() {
  return (
    ...
    >
      ...
      <div>
        <h2 className="text-lg font-bold text-slate-900 mb-3">Markenrecht</h2>
      ...
      <div>
        <h2 className="text-lg font-bold text-slate-900 mb-3">Streitbeilegung</h2>
      ...
      <div>
        <h2 className="text-lg font-bold text-slate-900 mb-3">Verbraucherstreitbeilegung</h2>
