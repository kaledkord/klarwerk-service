...
export default function AGB() {
  return (
    ...
    >
      ...
      <div>
        <h2 className="text-lg font-bold text-white mb-3">§ 2 Vertragsschluss</h2>
      ...
      <div>
        <h2 className="text-lg font-bold text-white mb-3">§ 3 Leistungen</h2>
      ...
      <div>
        <h2 className="text-lg font-bold text-white mb-3">§ 4 Preise und Zahlungsbedingungen</h2>
      ...
      <div>
        <h2 className="text-lg font-bold text-white mb-3">§ 5 Kündigung</h2>
      ...
      <div>
        <h2 className="text-lg font-bold text-white mb-3">§ 6 Haftung</h2>
      ...
      <div>
        <h2 className="text-lg font-bold text-white mb-3">§ 7 Geheimhaltung</h2>
