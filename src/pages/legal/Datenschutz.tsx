...
export default function Datenschutz() {
  return (
    ...
    >
      <div>
        <h2 className="text-lg font-bold text-white mb-3">1. Datenschutz auf einen Blick</h2>
      ...
      <div>
        ...
        <p className="whitespace-pre-line mt-2">
          ...
          E-Mail: info@klarwerk-service.com<br />
        </p>
      </div>
      <div>
        <h2 className="text-lg font-bold text-white mb-3">3. Erhebung und Speicherung personenbezogener Daten</h2>
      ...
      <div>
        <h2 className="text-lg font-bold text-white mb-3">4. Ihre Rechte</h2>
      ...
      <div>
        <h2 className="text-lg font-bold text-white mb-3">6. Server-Log-Files</h2>
      ...
      <div>
        <h2 className="text-lg font-bold text-white mb-3">7. Kontaktformular</h2>
